...
$map_colors = {
  ...
  country:     {color:'#f0f0f0', outline:'#444444'},
  ...
  sand:        {color:'#ddbb88', outline:"#ccaa77"},
  mud:         {color:'#ddcc88', outline:"#ccbb77"},
  military:    {color:'#888888', outline:"#444444"},
  tourism:     {color:'#ccaaff', outline:"#ccaaff"},
  school:      {color:'#ffffcc'},
  water:       {color:'#99b3cc'},
  ...
  road_1:      {color:'#aa9977', outline:'#666666'},
  road_2:      {color:'#bbaa88', outline:'#666666'},
  road_3:      {color:'#ccbb99', outline:'#666666'},
